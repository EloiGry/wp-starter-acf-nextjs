        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            ...
            <div className="mt-7 grid gap-3 w-full sm:inline-flex">
              <Link href={data.bouton_1.link.url} 
                className={buttonVariants({
                    size:"lg",
                })}> 
                    {data.bouton_1.label}
              </Link>
              <Link href={data.bouton_2.link.url} 
                className={buttonVariants({
                    size:"lg",
                    variant: "outline"
                })}> 
            ...
            <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
              ...
              <div className="py-5">
                ...
                <p className="mt-3 text-sm">
                  <span className="font-bold">4.6</span> /5 - 12k avis
                </p>
                <div className="mt-5">
                  <svg
              ...
              <div className="py-5">
                ...
                <p className="mt-3 text-sm">
                  <span className="font-bold">4.8</span> /5 - 5k avis
                </p>
                <div className="mt-5">
                  <svg
                    className="h-auto w-16"
